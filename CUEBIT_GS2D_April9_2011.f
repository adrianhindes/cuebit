	...
	integer :: i,j,nt,i1,i2,nco
	character(len=20) :: tch,rch,phich,zch,deech,depphich
	end module declare 

      program CUEBIT_GS2D_April9_2011
      use declare
      implicit none
      real :: terp2
...
ccc                                                                      ccc
ccc This is a single particle version of the code.                       ccc  
ccc                                                                      ccc
ccc Last modified by Ken McClements 8/4/11.                              ccc
ccc                                                                      ccc
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c
...
c
	write(6,fmt='("no. of coils, major radius of coils")')
        read(5,*)nco,rco
c
	t=0.d0
	x1=r1*cos(phi1)
...
c
        deltabph = (b0*r0/r1)*(r1/rco)**nco*cos(nco*phi1)
	deltabr = (b0*r0/r1)*(r1/rco)**nco*sin(nco*phi1)
c
	bph = bph+deltabph
	brr = brr+deltabr
...
c
	...
	write(8,fmt='(1p,6d11.3)')t,r2,phi2,z2,psi2,errpphi
      end program CUEBIT_GS2D_April9_2011
